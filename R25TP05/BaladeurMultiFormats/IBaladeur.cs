...
namespace BaladeurMultiFormats
{
    ...
    interface IBaladeur
    {
        ...
        /// </summary>
        /// <param name="pListView">La ListView à afficher.</param>
        ...
        /// <returns>Retourne la chanson à l'index pIndex se trouvant dans le m_colChansons.</returns>
        ...
        /// <summary>
        /// Méthode servant à convertir n'importe quelle chanson au format AAC (sauf lorsqu'il est déjà en format AAC). 
        /// </summary>
        /// <param name="pIndex">La chanson à convertir au format AAC.</param>
        void ConvertirVersAAC(int pIndex);
        /// <summary>
        /// Méthode servant à convertir n'importe quelle chanson au format MP3 (sauf lorsqu'il est déjà au format MP3).
        /// </summary>
        /// <param name="pIndex">La chanson à convertir au format MP3.</param>
        void ConvertirVersMP3(int pIndex);
        /// <summary>
        /// Méthode servant à convertir n'importe quelle chanson au format WMA (sauf lorsqu'il est déjà en format WMA).
        /// </summary>
